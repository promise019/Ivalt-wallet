...
export default function Home() {
  ...
  return (
    <main className="text-white min-h-screen bg-black px-4 pt-4 overflow-y-auto max-w-full md:px-15 md:ml-[17%] lg:ml-[14%] xl:ml-[12%] md:max-w-[83%] lg:max-w-[86%] xl:max-w-[88%] overflow-x-hidden">
      {/* Header */}
      <User className="w-6 h-6 text-green-400 inline-block" />
      <h1 className="text-lg font-bold mb-6 inline">Hi, Daniel</h1>

      <div className="lg:grid lg:grid-cols-2 lg:gap-3 xl:gap-7">
        ...
        <div>
          ...
          {/* Actions */}
          <div className="grid p-1 grid-cols-4 gap-2 mt-4 md:gap-6">
